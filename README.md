...
delete 함수와 기본 과제에서 수행하였던 상태 별 삭제를 구현하기 위하여 where 함수를 사용하여 데이터베이스에 저장된 할 일들의 상태에 따라 삭제 할 데이터를 불러와 삭제 하였다.

![image](https://user-images.githubusercontent.com/53864655/72239837-9f265200-3625-11ea-87b8-d4598c96d6fd.png)

* 수정

update 함수를 사용하여 부분적으로 수정된 부분만 업데이트 되어 저장되도록 하였다. 
